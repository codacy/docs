...
---
import AdminAccessControlInfo from '../../_includes/AdminAccessControlInfo.mdx'
...
1.  Open the **Commits** page for your repository and select the correct branch at the top of the page if you configured Codacy to [analyze multiple branches](../../repositories-configure/managing-branches.mdx).
...
-   [Commit status](../../repositories/commits.mdx#status)
-   [Pull request status](../../repositories/pull-requests.mdx#status)
