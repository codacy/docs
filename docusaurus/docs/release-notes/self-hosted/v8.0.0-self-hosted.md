...
slug: /release-notes/self-hosted/self-hosted-v8.0.0
---
...
The previous Codacy Self-hosted version [already included ESLint 8 as a new supported tool and deprecated ESLint 7](/release-notes/self-hosted/self-hosted-v7.0.0#product-enhancements), and Codacy recommends that you migrate to the new version of the tool to benefit from the new features and fixes of ESLint.
