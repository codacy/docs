...
slug: /release-notes/cloud/cloud-2022-10
---
...
-   Improved the performance and error handling of retrieving many open pull requests from the Git providers while populating the [**Pull requests** page](../../../repositories/pull-requests.mdx). (IO-133)
