...
slug: /release-notes/cloud/cloud-2022-08
---
...
-   Codacy now displays the coverage variation metric with a precision of two decimal places on the [Pull request](../../../repositories/pull-requests.mdx), [Commit](../../../repositories/commits.mdx), and [Files](../../../repositories/files.md) page.
