...
slug: /release-notes/cloud/cloud-2022-09
---
...
-   Now, the **Files** tab on [Pull request](../../../repositories/pull-requests.mdx#files-tab) and [Commit](../../../repositories/commits.mdx#files-tab) pages displays only files with a variation of their code quality metrics, to make it more convenient to analyze the impact of your changes on the code quality of the files.
