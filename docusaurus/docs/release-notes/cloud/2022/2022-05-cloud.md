...
slug: /release-notes/cloud/cloud-2022-05
---
...
-   Codacy now [displays diff coverage as not applicable](../../../repositories/pull-requests.mdx#quality-overview) (represented by `∅`) when there are no coverable lines included in a pull request, and correctly reports the pull request status on your Git provider in this scenario. (CY-5960)
