...
slug: /release-notes/cloud/cloud-2024-06
---
...
-   On June 5th, Codacy [stopped sending status checks from the old Coverage engine](/release-notes/cloud/cloud-2023-11-23-new-coverage-engine-status-checks#deprecation-and-removal-calendar-for-the-old-coverage-engine-status-checks). (ALA-767)
