...
slug: /release-notes/cloud/cloud-2024-04
---
...
-   Codacy no longer updates the [default branch](../../../repositories-configure/managing-branches.mdx) automatically when you change the default branch on your Git provider. (TCE-838)
