...
!!! note
    Remember that scans run nightly (UTC). If you just uploaded the SBOM file, but need results immediately, consider using our [Codacy Analysis CLI](https://www.npmjs.com/package/@codacy/analysis-cli) to run a local analysis to scan for any issues.
