...
The **Last updated repositories** list displays the repositories with recent pushed commits or changes to the repository itself, sorted by reverse date of the last update. Each card displays the date of the last update and the current grade of the repository.
...
!!! important
    **If you're using Bitbucket Server** the list displays the repositories in alphabetical order because Codacy can't obtain the date when each repository was last updated from this Git provider.
