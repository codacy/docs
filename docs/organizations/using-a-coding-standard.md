...
!!! important
    -   If a coding standard doesn't include a tool, any pre-existing repository settings for that tool aren't modified by the coding standard.
...
1.  <!-- TODO PUL-368 Review permissions for this action. This may require no change -->Select existing repositories that should follow the new coding standard and click **Save and apply standard**.
