...
This will run Postgres in a new docker, naming the container 'application\_db'. Also, the user 'postgres' will have its password changed to 'mysecretpassword'. Feel free to change this to whatever you want.
