...
<div class="topic-row">
  <a class="topic-card" href="user-guide/configure-your-repo/add-coverage-to-your-repo/">
    <div class="tc-icon">
  ...
  <a class="topic-card"  href="user-guide/related-tools/client-side-tools/">
    <div class="tc-icon">
  ...
  <a class="topic-card"  href="user-guide/synced-organizations/adding-and-managing-authors/">
    <div class="tc-icon">
