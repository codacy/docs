...
For an issue you disagree with or false positives, you can either ignore that instance or disable the pattern across the whole repository. To do so, click on <img src="/v1.4/images/image-2.png" width="45" height="27" /> and select the desired option.
...
When you want to remove a pattern altogether from your repository's analysis, expand the issue you’re aiming to disable the pattern for, click on <img src="/v1.4/images/image-2.png" width="45" height="27" />, select **Remove pattern** and confirm your choice.
...
You can cherry-pick files to be ignored for further analysis. To ignore a file, expand the issue, click on <img src="/v1.4/images/360012544353/image-2.png" width="45" height="27" />, select **Ignore file** from the menu, and confirm.
