...
<!--highlight-->**Draft PR AI review control:** The PR reviewer no longer runs automatically on draft pull requests — trigger it manually from the summary page when you want a review.<!--/highlight--> Also this month: AI suggestions in GitHub are deprecated in favor of the PR reviewer, AI Inventory access moves to Business Tier accounts, and YAML analysis now covers `.env`, `.env.production`, `.env.prod`, and `.env.staging` files.
