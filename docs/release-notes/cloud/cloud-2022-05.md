...
-   Now, Codacy [displays diff coverage as not applicable](../../repositories/pull-requests.md#pull-request-quality-overview) (represented by `∅`) when there are no coverable lines included in a pull request. ![Not applicable diff coverage](../images/cy-5960.png) (CY-5960)
