...
<!--highlight-->**Import chain visibility for vulnerable dependencies:** Codacy now shows the dependency chain behind a vulnerability, so you can see how it was introduced into your project rather than just that it exists.<!--/highlight--> Also this month: the CI/CD setup option for container scanning is easier to find, and Guardrails now supports proxy configurations for restricted network environments.
