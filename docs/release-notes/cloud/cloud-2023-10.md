...
-   Codacy will drop support for branches named HEAD or matching the pattern refs/heads/*. These names are reserved for git and should not be used as branch names. (IO-830)
