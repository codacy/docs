...
-   You can now [quickly create a new coding standard](../../organizations/using-coding-standards.md#creating) by activating code patterns in bulk from preset category groups. This option is also available when setting up a new organization to create a default coding standard. (ALA-824)
