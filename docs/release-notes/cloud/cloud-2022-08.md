...
-   Now, the Organization Overview allows filtering repositories to help you see and focus on the information for the repositories that matter most to you and your team.

The filter drop-down list allows using the programming language to narrow down the repositories that you can choose from, and the selected repositories are stored in your browser so that the same filter is applied between your visits to the Organization Overview page. ![Repository filter on the Organization Overview](../images/cy-5573.png) CY-5573
