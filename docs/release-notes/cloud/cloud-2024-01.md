...
-   You can now filter the [security and risk items](../../security/index.md) by security category. (TAROT-2444)
...
-   The repository security monitor has been replaced by the [Security and risk management feature](../../security/index.md), which shows the information related to the repositories that each member follows. (TAROT-2444)
