...
-   As result of improvements in the mechanism to refresh organizations from the Git provider, we removed the option to manually refresh the list of organizations when adding new organizations to Codacy. (ALA-862)
