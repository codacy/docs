...
-   Fixed an issue affecting the diff coverage for pull requests with many file deletions. (ALA-880)
-   Fixed an issue causing the Codacy Diff Coverage status check to block. (ALA-869)
