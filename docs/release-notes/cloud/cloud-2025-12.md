...
-   **getCodeBlock Endpoint Update:** The getCodeBlock endpoint was deleted and replaced with getFileContent. They provide the same functionality but rely on different path parameters. See documentation (TAROT-3580)
