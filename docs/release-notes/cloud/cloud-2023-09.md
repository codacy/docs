...
-   Fixed an issue where providers that don't send events for change of main branch (Bitbucket, GitLab) would get an empty dashboard page and failures to analyse PRs that targeted the main branch. (IO-799)
