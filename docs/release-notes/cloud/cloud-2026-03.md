...
<!--highlight-->**AI security and privacy safeguards:** The AI reviewer and false positive detection now automatically mask secrets or credentials accidentally pushed in code, before that code reaches AI models.<!--/highlight--> Also this month: a `review.md` file lets you tune the AI Reviewer's output with your own conventions, a manual "Run review" button gives you control over when it runs, and the AI Reviewer now flags gaps in test coverage with a ready-to-use prompt for your coding agent.
...
- **Issue Reporting Update:** We have addressed a bug that caused Codacy to underreport issues between February 11 and March 19, 2026. For more details on the impact and resolution, please refer to our [status update](https://status.codacy.com/incidents/kQ6dnzLtFB8n). (TAROT-3654)
