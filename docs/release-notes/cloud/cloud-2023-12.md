...
-   The [Security and risk management feature](../../security/index.md), previously only available to organization admins and security managers, is now open to all organization members and shows information related to the repositories that each member follows. (TAROT-2442)
