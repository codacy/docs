...
-   When calculating coverage data, the [new coverage engine](./cloud-2023-11-23-new-coverage-engine-status-checks.md) now ignores files in the coverage report that are not in the associated Git repository. (ALA-716)
-   The [GitHub coverage summaries](./cloud-2023-11-23-new-coverage-engine-status-checks.md#coverage-summaries) and the [Codacy app UI diff tabs](./cloud-2023-11-23-new-coverage-engine-status-checks.md#diff-tabs) now get data from the new Coverage engine. For more information, [see the rollout details of the new Coverage engine](./cloud-2023-11-23-new-coverage-engine-status-checks.md). (ALA-589, ALA-676)
