...
-   **If your legacy organization is using the Open source plan** then Codacy has already stopped analyzing your repositories. To restore the analysis of your repositories please wait until Codacy attempts to migrate your organization.
