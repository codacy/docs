...
1.  Check the [release notes for all Codacy Self-hosted versions](../category/self-hosted/) **between your current version and the most recent version** for breaking changes and follow the instructions provided <span class="skip-vale">carefully</span>.
...
See [how to migrate your configuration files to use ESLint 8](cloud-2022-03-31-adding-eslint8.md#migrating-your-configuration-files-to-use-eslint-8). (CY-5848)
