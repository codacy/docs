...
-   You can now use [personal organizations](../../organizations/what-are-organizations.md#adding-an-organization) to manage your personal repositories. (CY-1802)
-   Updated the [Organization](../../organizations/reporting/organization-overview.md) and [Repository](../../repositories/repository-dashboard.md) dashboards with a cleaner user experience and better performance. (CY-1733)
...
-   Scalastyle 1.0.0
-   ShellCheck 0.7.1
-   **SonarC# 8.13 (updated from 8.12)**
-   **SonarVB 8.13 (updated from 8.12)**
-   SpotBugs 4.1.2
-   SQLint 0.1.9
