...
By default, Codacy ignores all the files that match the regular expressions below. If you want to override these defaults, [use a Codacy configuration file](codacy-configuration-file.md).
