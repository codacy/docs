...
!!! tip
    Improve the AI Reviewer results by providing custom instructions to the AI Reviewer. [Learn how to do it here →](../../codacy-ai/codacy-ai.md#custom-instructions).
