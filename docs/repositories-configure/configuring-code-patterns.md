...
-   Codacy will use tool configuration files even if you ignore them [using the Codacy UI](ignoring-files.md) or [in a Codacy configuration file](codacy-configuration-file.md).
