...
While Codacy will ignore your file by default, you can still analyze it by running the analysis locally using the [Codacy Analysis CLI](https://github.com/codacy/codacy-analysis-cli#codacy-analysis-cli). The Codacy Analysis CLI doesn't have any limitation on file size.
