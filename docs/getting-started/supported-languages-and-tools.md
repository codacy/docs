...
<sup><span id="dart-limitations">3</span></sup>: Currently, Codacy only supports following `include` on analysis_options.yaml file: [lints](https://pub.dev/packages/lints) and [flutter_lints](https://pub.dev/packages/flutter_lints).  
