...
<sup><span id="dart-limitations">3</span></sup>: Currently, Codacy only supports following `include` on _analysis_options.yaml_ file: [lints](https://pub.dev/packages/lints) and [fluttler_lints](https://pub.dev/packages/flutter_lints) .  
