...
You just have to go to your repository's Security Tab, click on <img src="/v2.0/images/morebutton.png" width="80" height="32" alt="morebutton.png" /> and select the relevant option.
